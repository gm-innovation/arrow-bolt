  ...
  return (
    <div className="space-y-4 max-w-2xl">
      <p className="text-sm text-muted-foreground">
        Sua assinatura é usada nos documentos da Qualidade quando você aprova, dá ciência, revisa ou
        encerra um registro. Cada uso fica registrado com data, hora e versão do documento.
      </p>
      <Card>
        <CardHeader>
