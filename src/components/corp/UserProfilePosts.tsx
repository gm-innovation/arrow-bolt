  ...
  const { data: posts = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data } = await supabase
        ...
        .select('id, content, title, created_at, author_id, profiles:profiles!corp_feed_posts_author_id_fkey(full_name, avatar_url), corp_feed_attachments(id, file_url, file_type, file_name, file_size, mime_type)')
