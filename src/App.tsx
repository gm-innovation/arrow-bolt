...
const CommercialSales = lazy(() => import("./pages/commercial/Sales"));
const CommercialAiInsights = lazy(() => import("./pages/commercial/AiInsights"));
...
const HRTimesheet = lazy(() => import("./pages/hr/Timesheet"));
...
const QualityEmployeeDocuments = lazy(() => import("./pages/quality/EmployeeDocuments"));
              ...
              <AuthProvider>
                <SidebarProvider>
                  ...
                  <Route element={<ProtectedRoute allowedRoles={['commercial', 'marketing']}><DashboardLayout userType="commercial" /></ProtectedRoute>}>
                    ...
                    <Route path="/commercial/sales" element={<CommercialSales />} />
                    <Route path="/commercial/ai-insights" element={<CommercialAiInsights />} />
