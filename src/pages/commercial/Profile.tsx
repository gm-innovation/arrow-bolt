...
const CommercialProfile = () => {
  ...
  const onSubmit = async (data: ProfileFormData) => {
    ...
    try {
      ...
      toast({ title: "Erro ao atualizar", description: "Não foi possível atualizar o perfil. Tente novamente.", variant: "destructive" });
    } finally {
      setIsLoading(false);
    }
  };
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid gap-4">
              <div className="grid gap-2">
                ...
                <Input id="full_name" {...register("full_name", { required: "Nome é obrigatório" })} placeholder="Seu nome completo" />
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" onClick={() => setPasswordDialogOpen(true)}>Alterar Senha</Button>
          </div>
        </CardContent>
      </Card>
