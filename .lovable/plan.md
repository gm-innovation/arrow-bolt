...
- Fazer login no `rhid.com.br` de forma automatizada e capturar as requisições de autenticação e de "Baixar AFD do REP" / relatório de marcações (URL, cabeçalhos, formato da resposta).
